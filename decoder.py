...
labels = ((0b01, ( 2, xLeftLabel,  "Temp dial  . . . . :", 21)), # 0x00 - temp dial, left
          ...
          (0b01, (17, xLeftLabel,  "Mixing chamber temp:", 21)), # 0x05 - left
          (0b00, (17, xLeftLabel,  ""                    , 33)), # 0x06 - right
          (0b01, ( 6, xLeftLabel,  "Interior temp  . . :", 21)), # 0x07 - interior temp, raw
          (0b01, (15, xRightLabel, "Exterior temp  . . :", 21)), # 0x08 - exterior temp
          ...
          (0b01, (13, xLeftLabel,  "^^ fast (valve ctr):", 21)), # 0x0c - left, fast
          (0b00, (13, xLeftLabel,  ""                    , 33)), # 0x0d - right, fast
          (0b01, (15, xLeftLabel,  "^^ slow (feedback) :", 21)), # 0x0e - left, slow
          (0b00, (15, xLeftLabel,  ""                    , 33)), # 0x0f - right, slow
          (0b01, (14, xLeftLabel,  "^^ mid . . . . . . :", 21)), # 0x10 - left, mid
          (0b00, (14, xLeftLabel,  ""                    , 33)), # 0x11 - right, mid
          (0b01, (19, xLeftLabel,  "Valve feedback ctrl:", 21)), # 0x12 - left valve feedback control bias
          (0b00, (19, xLeftLabel,  ""                    , 33)), # 0x13 - right valve feedback control bias
          (0b01, (20, xLeftLabel,  "Valve duty cycle . :", 21)), # 0x14 - left duty cycle
          (0b00, (20, xLeftLabel,  ""                    , 33)), # 0x15 - right duty cycle
          ...
          (0b11, ((12, xRightLabel, "Center vents heat  :", 21), # 0x1c/0 - center vents temp control: 0 = heating bypassed; 1 = heated
                  ...
                  (21, xLeftLabel,  "Water pump . . . . :", 30), # 0x1c/7 - water recirculation pump
                  )
           ),
