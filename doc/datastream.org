...
# In Mercedes-Benz documentation for the automatic A/C matching 122 °C
# and 117 °C temperatures were discovered.  In this protection mode a
# 50% duty cycle for the A/C compressor was also documented with time
# periods of 20 seconds off and 20 seconds on, which matches with the
# counter.
...
*** TODO Interior air, mixing chamber, and evaporator temperatures – pins 9, 11, 12, 13

mix : Mixing chamber temperature (0x05 and 0x06) – resistance range
between 820 Ω and 19.6 kΩ.
...
*** TODO Exterior air temperature – pin 10

Data index 0x08.  Resistance range between 100 Ω and >47 kΩ.
...
Pull-up resistor value is likely 2.7 kΩ.


*** TODO Engine coolant temperature – pin 14

Data index 0x16.  Resistance range between 158 Ω and 10-15 kΩ.
